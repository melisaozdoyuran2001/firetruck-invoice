...
const styles = StyleSheet.create({
  page: { padding: 40, fontSize: 11, fontFamily: 'Helvetica', backgroundColor: '#ffffff', color: '#333333' },
  headerContainer: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 30, borderBottom: '2 solid #e0e0e0', paddingBottom: 20 },
  headerLogoText: { width: '30%', alignItems: 'flex-start' },
  logoImage: { width: 80, height: 50, marginBottom: 5 },
  headerTitleSection: { width: '70%', alignItems: 'flex-end' },
  documentTitle: { fontSize: 16, color: '#003366', marginTop: 5 },
  invoiceDetailsContainer: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 },
  invoiceNumberSection: { width: '45%' },
  invoiceNumber: { fontSize: 12, fontWeight: 'bold' },
  invoiceDate: { marginTop: 5 },
  addressSection: { width: '45%' },
  sectionTitle: { fontSize: 12, fontWeight: 'bold', marginBottom: 6, color: '#003366', textTransform: 'uppercase' },
  addressText: { marginBottom: 3 },
  divider: { borderBottom: '1 solid #e0e0e0', marginVertical: 15 },
  vehicleInfoContainer: { marginBottom: 20 },
  vehicleInfoRow: { flexDirection: 'row', marginBottom: 8 },
  vehicleInfoKey: { width: '35%', fontWeight: 'bold' },
  vehicleInfoValue: { width: '65%' },
  descriptionContainer: { marginBottom: 20 },
  descriptionText: { lineHeight: 1.5 },
  vehicleImage: { width: 300, height: 'auto', marginBottom: 10, border: '1 solid #ccc' },
  imageNotice: { fontSize: 9, fontStyle: 'italic', color: '#666666', marginTop: 5 },
  pricingContainer: { marginBottom: 20 },
  pricingRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 5 },
  totalRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10, paddingTop: 10, borderTop: '1 solid #e0e0e0', fontWeight: 'bold' },
  signatureContainer: { marginTop: 30, flexDirection: 'row', justifyContent: 'space-between' },
  signatureSection: { width: '45%' },
  signatureLine: { borderTop: '1 solid #000000', marginTop: 40, paddingTop: 5, width: '90%' },
  termsContainer: { marginTop: 40, padding: 10, backgroundColor: '#f9f9f9', borderRadius: 5 },
  termsTitle: { fontWeight: 'bold', marginBottom: 5 },
  termsText: { fontSize: 9, lineHeight: 1.4 },
  footer: { marginTop: 30, padding: '10 0', fontSize: 9, textAlign: 'center', color: '#777777', borderTop: '1 solid #e0e0e0' },
  watermark: { position: 'absolute', top: '50%', left: '30%', color: '#e0e0e0', fontSize: 60, opacity: 0.3, transform: 'rotate(-45deg)' }
});
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.invoiceDetailsContainer}>
          ...
          <View style={styles.addressSection}>
            ...
            <Text style={styles.addressText}>Contact: {data?.user?.email || 'sales@garage.com'}</Text>
            <Text style={styles.addressText}>ID: {data?.userId?.substring(0, 8) || 'GARAGE-VENDOR'}</Text>
          </View>
        </View>
